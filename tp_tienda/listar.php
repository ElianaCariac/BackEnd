...
<head>
    ...
    <title>SHOPSTORE | Tienda de Ropa Deportiva</title>
</head>
<body>
    <h1>SHOPSTORE | Tienda de Ropa Deportiva</h1>
    ...
    <h2>Lista de ropa</h2>
    <p>La siguiente lista muestra los datos de la ropa que está actualmente en stock.</p>
    <table border="1">
    <tr>
        <th>ID</th>
